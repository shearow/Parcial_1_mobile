...
fun main() {
        ...
        /************* REGISTRAR SOCIO *************/
        var socioTest1 = Socio("Jorge", "321231", Sexo.MASCULINO, "emailTest@gmail.com");
        var socioTest2 = Socio("Maria", "3123", Sexo.FEMENINO);
        ...
        disciplina1.tomarSociosInscriptos().forEach({it -> println("Nombre: ${it.nombre}, Id: ${it.id}")});
